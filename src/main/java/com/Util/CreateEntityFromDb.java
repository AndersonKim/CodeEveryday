...
public class CreateEntityFromDb {
	private String tableName = "SPT_LOGIN_INFO";
	...
	//数据库连接  
	private static final String URL ="jdbc:oracle:thin:@172.27.130.112:1521:orcl";
	private static final String NAME = "ESF";
	private static final String PASS = "xdrcft56";
	...
	public static void main(String[] args) throws SQLException {
		...
		t.tableToEntity("ESF.", "SPT_LOGIN_INFO", -1, "com.wondersgroup.esfimpl.homePage.bo", true);
	}
	 ...
	 * @throws SQLException
	 */
	public void tableToEntity(String schemaName, String tName, int uuidFieldIndex, String packageName, boolean extendBaseBO) throws SQLException {
